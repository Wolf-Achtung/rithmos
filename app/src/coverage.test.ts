...
describe('coverage trend', () => {
  it('window average over the last 50 moves', () => {
    ...
    const records = Array.from({ length: 60 }, (_, i) => ({ id: `r${i}`, t: i * day, coverage: i < 10 ? 0 : 1, assist: 0 }));
  ...
  it('buckets by week, oldest first', () => {
    ...
    const trend = weeklyTrend([
      { id: 'a', t: w2 + day, coverage: 1, assist: 0 },
      { id: 'b', t: w1 + day, coverage: 0.5, assist: 0 },
      { id: 'c', t: w1 + 2 * day, coverage: 1, assist: 0 },
    ]);
